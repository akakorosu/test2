	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<input type="text" placeholder="IP端口" class="searchField input-md" id="ip_Port" name="ipPort">
	         ...
	         <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.DimIaIpPortDynamic" name="entityName"/>
					<jsp:param value="dimIaIpPortDynamicService" name="beanName"/>
					<jsp:param value="dim_ia_ip_port_dynamic.xlsx" name="templateName"/>
					<jsp:param value="0,1,2,3,4,5,6" name="fieldNums"/>
				    <jsp:param value="1,4" name="textFieldNums"/>
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/dimIaIpPortDynamic/dimIaIpPortDynamic.js"></script>
</html>