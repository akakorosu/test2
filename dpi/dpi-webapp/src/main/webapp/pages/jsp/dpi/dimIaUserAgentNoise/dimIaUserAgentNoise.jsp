	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<input type="text" placeholder="噪音规则" class="searchField input-md" id="noise_key" name="noiseKey">
				...
				<button class="btn btn-primary" type="button" id="searchNoiseList">查询</button>
				<button class="btn btn-primary" type="button" id="clearNoiseSearch" onclick="topclear('gridSearch')">清空</button>
	            <button class="btn btn-warning" type="button" id="createNoiseBtn">新建</button>
			    <button class="btn btn-warning" type="button" id="backtoye">返回</button>
				<!--批处理 -->
	           	<jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.DimIaUserAgentNoise" name="entityName"/>
					<jsp:param value="dimIaUserAgentNoiseService" name="beanName"/>
					<jsp:param value="dim_ia_useragent_noise.xlsx" name="templateName"/>
					<jsp:param value="0,1,2,3" name="fieldNums"/>
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/dimIaUserAgentNoise/dimIaUserAgentNoise.js"></script>
</html>