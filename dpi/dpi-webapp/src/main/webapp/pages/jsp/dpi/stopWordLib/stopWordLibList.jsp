...
<cxt:commonLinks />
	...
	<script src="<%=request.getContextPath()%>/pages/jsp/dpi/stopWordLib/stopWordLibList.js"></script>
	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<input type="text" placeholder="停用关键词" class="searchField input-md" id="stopWord" name="stopWord">
				...
				<button class="btn btn-primary" type="button" id="searchSwlList">查询</button>
				<button class="btn btn-primary" type="button" id="clearList" onclick="topclear('gridSearch')">清空</button>
	            <button class="btn btn-warning" type="button" id="createSwlBtn" >新建</button>
	            
				<!--批处理 -->
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.StopWordLib" name="entityName"/>
					<jsp:param value="stopWordLibService" name="beanName"/>
					<jsp:param value="dim_ia_stop_word_lib.xlsx" name="templateName"/>
