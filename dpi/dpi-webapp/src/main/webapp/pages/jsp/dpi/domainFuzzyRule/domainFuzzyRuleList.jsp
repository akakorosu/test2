...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/domainFuzzyRule/domainFuzzyRuleList.js"></script>
	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<input type="text" placeholder="截取规则" class="searchField input-md" id="parse_rule" name="parseRule">
	            ...
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.DomainFuzzyRule" name="entityName"/>
					<jsp:param value="domainFuzzyRuleService" name="beanName"/>
					<jsp:param value="domain_fuzzy_rule.xlsx" name="templateName"/>
