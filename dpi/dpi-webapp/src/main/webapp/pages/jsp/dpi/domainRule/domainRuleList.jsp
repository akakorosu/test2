...
<head>
	...
	<script src="<%=request.getContextPath()%>/pages/jsp/dpi/domainRule/domainRuleList.js"></script>
	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
	            ...
	            <button class="btn btn-warning" type="button" id="createDrBtn" >新建</button>
	            
				<!--批处理 -->
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.DomainRule" name="entityName"/>
					<jsp:param value="domainRuleService" name="beanName"/>
					<jsp:param value="dim_ia_domain_rule.xlsx" name="templateName"/>
