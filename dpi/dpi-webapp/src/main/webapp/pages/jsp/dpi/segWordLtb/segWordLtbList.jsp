...
<cxt:commonLinks />
	...
	<script src="<%=request.getContextPath()%>/pages/jsp/dpi/segWordLtb/segWordLtbList.js"></script>
	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<input type="text" placeholder="分词" class="searchField input-md" id="seg_word" name="segWord">
	            ...
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.SegWordLtb" name="entityName"/>
					<jsp:param value="segWordLtbService" name="beanName"/>
					<jsp:param value="seg_word_ltb.xlsx" name="templateName"/>
