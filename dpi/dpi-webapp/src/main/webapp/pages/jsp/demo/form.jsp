...
$(function(){
	...
	$('input[name=date-range-picker]').daterangepicker({}).on('apply.daterangepicker', function(ev, picker) {
    	alert(picker.startDate.format('YYYY-MM-DD') + "///" + picker.endDate.format('YYYY-MM-DD') + "///" + picker.startDate.format('YYYY-MM-DD')+" 至 "+picker.endDate.format('YYYY-MM-DD'));
	})
