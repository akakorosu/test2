...
(function(e, t) {
	...
	(function(l) {
		var i = 3;
		try {
			var u = l.fn.dropdown.Constructor.VERSION;
			u !== void 0 && (i = parseInt(u, 10))
		} catch(t) {}
		var s = {
				3: {
			...
			r = {
				...
				getFieldTitle: function(e, t) {
					var o = !0,
						...
						a = void 0;
					try {
						for(var n, s, l = e[Symbol.iterator](); !(o = (n = l.next()).done); o = !0)
							if(s = n.value, s.field === t) return s.title
					} catch(e) {
						i = !0, a = e
					} finally {
						try {
				...
				setFieldIndex: function(e) {
					var t = 0,
						...
						s = void 0;
					try {
						for(var l, d, p = e[0][Symbol.iterator](); !(a = (l = p.next()).done); a = !0) d = l.value, t += d.colspan || 1
					} catch(e) {
						n = !0, s = e
					} finally {
						try {
					...
					for(var v = 0; v < e.length; v++) {
						var c = !0,
							...
							u = void 0;
						try {
							for(var g, f = e[v][Symbol.iterator](); !(c = (g = f.next()).done); c = !0) {
								var b = g.value,
									r = b.rowspan || 1,
									m = b.colspan || 1,
									y = o[v].indexOf(!1);
								1 === m && (b.fieldIndex = y, 'undefined' == typeof b.field && (b.field = y));
								for(var x = 0; x < r; x++) o[v + x][y] = !0;
								for(var k = 0; k < m; k++) o[v][y + k] = !0
							}
						} catch(e) {
							h = !0, u = e
						} finally {
				...
				getScrollBarWidth: function() {
					if(this.cachedWidth === void 0) {
						var e = l('<div/>').addClass('fixed-table-scroll-inner'),
							t = l('<div/>').addClass('fixed-table-scroll-outer');
						t.append(e), l('body').append(t);
				...
				calculateObjectValue: function(e, o, i, a) {
					var s = o;
					if('string' == typeof o) {
						var u = o.split('.');
						if(1 < u.length) {
							...
							var l = !0,
								...
								d = void 0;
							try {
								for(var p, c, h = u[Symbol.iterator](); !(l = (p = h.next()).done); l = !0) c = p.value, s = s[c]
							} catch(e) {
								r = !0, d = e
							} finally {
								try {
					...
					return null !== s && 'object' === ('undefined' == typeof s ? 'undefined' : n(s)) ? s : 'function' == typeof s ? s.apply(e, i || []) : !s && 'string' == typeof o && this.sprintf.apply(this, [o].concat(t(i))) ? this.sprintf.apply(this, [o].concat(t(i))) : a
				},
				compareObjects: function(e, t, o) {
					...
					var n = !0,
						...
						l = void 0;
					try {
						for(var r, d, p = i[Symbol.iterator](); !(n = (r = p.next()).done); n = !0)
							if(d = r.value, a.includes(d) && e[d] !== t[d]) return !1
					} catch(e) {
						s = !0, l = e
					} finally {
						try {
				...
				getRealDataAttr: function(e) {
					var t = !0,
						...
						i = void 0;
					try {
						for(var n, s = Object.entries(e)[Symbol.iterator](); !(t = (n = s.next()).done); t = !0) {
							var l = n.value,
								r = a(l, 2),
								d = r[0],
								p = r[1],
								c = d.split(/(?=[A-Z])/).join('-').toLowerCase();
							c !== d && (e[c] = p, delete e[d])
						}
					} catch(e) {
						o = !0, i = e
					} finally {
				...
				getItemField: function(e, t, o) {
					...
					var a = t.split('.'),
						...
						l = void 0;
					try {
						for(var r, d, p = a[Symbol.iterator](); !(n = (r = p.next()).done); n = !0) d = r.value, i = i && i[d]
					} catch(e) {
						s = !0, l = e
					} finally {
						try {
				...
				findIndex: function(e, t) {
					var o = !0,
						...
						s = void 0;
					try {
						for(var l, r = e.entries()[Symbol.iterator](); !(o = (l = r.next()).done); o = !0) {
							var d = l.value,
								p = a(d, 2),
								c = p[0],
								i = p[1];
							if(JSON.stringify(i) === JSON.stringify(t)) return c
						}
					} catch(e) {
						n = !0, s = e
					} finally {
			...
			d = {
				...
				buttonsAlign: 'right',
				buttonsClass: s.classes.buttons,
				icons: s.icons,
				iconSize: void 0,
				iconsPrefix: s.iconsPrefix,
				onAll: function() {
					return !1
				},
		...
		var c = function() {
			function t(o, i) {
				e(this, t), this.options = i, this.$el = l(o), this.$el_ = this.$el.clone(), this.timeoutId_ = 0, this.timeoutFooter_ = 0, this.init()
			}
			return o(t, [{
				key: 'init',
				value: function() {
				...
				value: function() {
					if(this.options.locale) {
						var e = l.fn.bootstrapTable.locales,
							t = this.options.locale.split(/-|_/);
						t[0] = t[0].toLowerCase(), t[1] && (t[1] = t[1].toUpperCase()), e[this.options.locale] ? l.extend(this.options, e[this.options.locale]) : e[t.join('-')] ? l.extend(this.options, e[t.join('-')]) : e[t[0]] && l.extend(this.options, e[t[0]])
					}
				}
			}, {
				key: 'initContainer',
				...
				value: function() {
					var e = this,
						o = [],
						i = [];
					if(this.$header = this.$el.find('>thead'), this.$header.length ? this.options.theadClasses && this.$header.addClass(this.options.theadClasses) : this.$header = l('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el), this.$header.find('tr').each(function(e, t) {
							var a = [];
							l(t).find('th').each(function(e, t) {
								'undefined' != typeof l(t).data('field') && l(t).data('field', '' + l(t).data('field')), a.push(l.extend({}, {
									title: l(t).html(),
									class: l(t).attr('class'),
									titleTooltip: l(t).attr('title'),
									rowspan: l(t).attr('rowspan') ? +l(t).attr('rowspan') : void 0,
									colspan: l(t).attr('colspan') ? +l(t).attr('colspan') : void 0
								}, l(t).data()))
							}), o.push(a)
						}), Array.isArray(this.options.columns[0]) || (this.options.columns = [this.options.columns]), this.options.columns = l.extend(!0, [], o, this.options.columns), this.columns = [], this.fieldsColumnsIndex = [], r.setFieldIndex(this.options.columns), this.options.columns.forEach(function(o, a) {
							o.forEach(function(o, i) {
								var n = l.extend({}, t.COLUMN_DEFAULTS, o);
						...
						this.$el.find('>tbody>tr').each(function(t, o) {
							var n = {};
							n._id = l(o).attr('id'), n._class = l(o).attr('class'), n._data = r.getRealDataAttr(l(o).data()), l(o).find('>td').each(function(o, i) {
								for(var s = +l(i).attr('colspan') || 1, d = +l(i).attr('rowspan') || 1, p = o; a[t] && a[t][p]; p++);
								for(var h = p; h < p + s; h++)
									for(var u = t; u < t + d; u++) a[u] || (a[u] = []), a[u][h] = !0;
								var c = e.columns[p].field;
								n[c] = l(i).html(), n['_' + c + '_id'] = l(i).attr('id'), n['_' + c + '_class'] = l(i).attr('class'), n['_' + c + '_rowspan'] = l(i).attr('rowspan'), n['_' + c + '_colspan'] = l(i).attr('colspan'), n['_' + c + '_title'] = l(i).attr('title'), n['_' + c + '_data'] = r.getRealDataAttr(l(i).data())
							}), i.push(n)
					...
					this.header = {
						...
						o.push('<tr>'), 0 === n && !t.options.cardView && t.options.detailView && o.push('<th class="detail" rowspan="' + t.options.columns.length + '">\n            <div class="fht-cell"></div>\n            </th>\n          '), a.forEach(function(i, a) {
							var s = '',
								...
								d = '',
								p = '',
								c = r.sprintf(' class="%s"', i['class']),
								h = 'px',
								u = i.width;
							if(void 0 !== i.width && !t.options.cardView && 'string' == typeof i.width && i.width.includes('%') && (h = '%'), i.width && 'string' == typeof i.width && (u = i.width.replace('%', '').replace('px', '')), l = r.sprintf('text-align: %s; ', i.halign ? i.halign : i.align), d = r.sprintf('text-align: %s; ', i.align), p = r.sprintf('vertical-align: %s; ', i.valign), p += r.sprintf('width: %s; ', (i.checkbox || i.radio) && !u ? i.showSelectTitle ? void 0 : '36px' : u ? u + h : void 0), 'undefined' != typeof i.fieldIndex) {
							...
							var g = s;
							i.checkbox && (s = '', !t.options.singleSelect && t.options.checkboxHeader && (s = '<input name="btSelectAll" type="checkbox" />'), t.header.stateField = i.field), i.radio && (s = '', t.header.stateField = i.field, t.options.singleSelect = !0), !s && i.showSelectTitle && (s += g), o.push(s), o.push('</div>'), o.push('<div class="fht-cell"></div>'), o.push('</div>'), o.push('</th>')
						}), o.push('</tr>')
					}), this.$header.html(o.join('')), this.$header.find('th[data-field]').each(function(t, o) {
						l(o).data(e[l(o).data('field')])
					}), this.$container.off('click', '.th-inner').on('click', '.th-inner', function(o) {
						var e = l(o.currentTarget);
						...
						if(t.options.sortable && l(o.currentTarget).data().sortable) {
				...
				value: function() {
					var e = this,
						...
						var s = r.getItemField(n, t, e.options.escape),
							d = r.getItemField(a, t, e.options.escape),
							p = r.calculateObjectValue(e.header, e.header.sorters[i], [s, d, n, a]);
						return void 0 === p ? ((void 0 === s || null === s) && (s = ''), (void 0 === d || null === d) && (d = ''), e.options.sortStable && s === d && (s = n._position, d = a._position), l.isNumeric(s) && l.isNumeric(d)) ? (s = parseFloat(s), d = parseFloat(d), s < d ? -1 * o : s > d ? o : 0) : s === d ? 0 : ('string' != typeof s && (s = s.toString()), -1 === s.localeCompare(d) ? -1 * o : o) : e.options.sortStable && 0 === p ? o * (n._position - a._position) : o * p
				...
				value: function() {
					...
					})), this.options.search && (t = [], t.push(r.sprintf('<div class="%s-%s search">', s.classes.pull, this.options.searchAlign), r.sprintf('<input class="form-control' + r.sprintf(' input-%s', this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch()), '</div>'), this.$toolbar.append(t.join('')), a = this.$toolbar.find('.search input'), a.off('keyup drop blur').on('keyup drop blur', function(t) {
						e.options.searchOnEnterKey && 13 !== t.keyCode || [37, 38, 39, 40].includes(t.keyCode) || (clearTimeout(o), o = setTimeout(function() {
							e.onSearch(t)
						}, e.options.searchTimeOut))
					}), r.isIEBrowser() && a.off('mouseup').on('mouseup', function(t) {
				...
				value: function(e) {
					var t = e.currentTarget,
						...
						i = l.trim(l(t).val());
					this.options.trimOnSearch && l(t).val() !== i && l(t).val(i), i === this.searchText || (this.searchText = i, this.options.searchText = i, !o && (this.options.pageNumber = 1), this.initSearch(), o ? 'client' === this.options.sidePagination && this.updatePagination() : this.updatePagination(), this.trigger('search', i))
				}
			}, {
				key: 'initSearch',
				value: function() {
					...
					if('server' !== this.options.sidePagination) {
						if(this.options.customSearch) return void r.calculateObjectValue(this.options, this.options.customSearch, [this.searchText]);
						...
						this.data = o ? this.options.data.filter(function(e) {
							for(var t in o)
								if(Array.isArray(o[t]) && !o[t].includes(e[t]) || !Array.isArray(o[t]) && e[t] !== o[t]) return !1;
							return !0
						}) : this.options.data, this.data = t ? this.data.filter(function(o, a) {
							for(var c = 0; c < e.header.fields.length; c++)
								if(e.header.searchables[c]) {
									var i = l.isNumeric(e.header.fields[c]) ? parseInt(e.header.fields[c], 10) : e.header.fields[c],
										n = e.columns[e.fieldsColumnsIndex[i]],
										s = void 0;
									if('string' == typeof i) {
										s = o;
										for(var d = i.split('.'), p = 0; p < d.length; p++) null !== s[d[p]] && (s = s[d[p]])
									} else s = o[i];
									if(n && n.searchFormatter && (s = r.calculateObjectValue(n, e.header.formatters[c], [s, o, a], s)), 'string' == typeof s || 'number' == typeof s)
				...
				value: function() {
					...
					if('server' !== this.options.sidePagination && (this.options.totalRows = g.length), this.totalPages = 0, this.options.totalRows) {
						if(this.options.pageSize === this.options.formatAllRows()) this.options.pageSize = this.options.totalRows, a = !0;
						else if(this.options.pageSize === this.options.totalRows) {
							var $ = 'string' == typeof this.options.pageList ? this.options.pageList.replace('[', '').replace(']', '').replace(/ /g, '').toLowerCase().split(',') : this.options.pageList;
							$.includes(this.options.formatAllRows().toLowerCase()) && (a = !0)
						}
					...
					if(0 < this.totalPages && this.options.pageNumber > this.totalPages && (this.options.pageNumber = this.totalPages), this.pageFrom = (this.options.pageNumber - 1) * this.options.pageSize + 1, this.pageTo = this.options.pageNumber * this.options.pageSize, this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows), o.push(r.sprintf('<div class="%s-%s pagination-detail">', s.classes.pull, this.options.paginationDetailHAlign), '<span class="pagination-info">', this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) : this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), '</span>'), !this.options.onlyInfoPagination) {
						...
						var P = [r.sprintf('<span class="btn-group %s">', 'top' === this.options.paginationVAlign || 'both' === this.options.paginationVAlign ? 'dropdown' : 'dropup'), '<button type="button" class="btn' + r.sprintf(' btn-%s', this.options.buttonsClass) + r.sprintf(' btn-%s', this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">', a ? this.options.formatAllRows() : this.options.pageSize, '</span>', ' <span class="caret"></span>', '</button>', s.html.pageDropdown[0]];
						if('string' == typeof this.options.pageList) {
							var C = this.options.pageList.replace('[', '').replace(']', '').replace(/ /g, '').split(',');
							f = [];
							var b = !0,
								m = !1,
								y = void 0;
							try {
								for(var w, v, k = C[Symbol.iterator](); !(b = (w = k.next()).done); b = !0) v = w.value, f.push(v.toUpperCase() === this.options.formatAllRows().toUpperCase() || 'UNLIMITED' === v.toUpperCase() ? this.options.formatAllRows() : +v)
							} catch(e) {
								m = !0, y = e
							} finally {
								try {
						...
						if(1 < i) {
							var T = this.options.paginationPagesBySide;
							for(T >= i && (T = i - 1), n = 1; n <= T; n++) o.push(S(n));
							i - 1 === T + 1 ? (n = i - 1, o.push(S(n))) : i - 1 > T && (i - 2 * this.options.paginationPagesBySide > this.options.paginationPagesBySide && this.options.paginationUseIntermediate ? (n = e((i - x) / 2 + x), o.push(S(n, ' page-intermediate'))) : o.push('\n                  <li class="page-item page-first-separator disabled">\n                    <a class="page-link" href="#">...</a>\n                  </li>'))
						}
						for(n = i; n <= d; n++) o.push(S(n));
						if(this.totalPages > d) {
							var O = this.totalPages - (this.options.paginationPagesBySide - 1);
							for(d >= O && (O = d + 1), d + 1 === O - 1 ? (n = d + 1, o.push(S(n))) : O > d + 1 && (this.totalPages - d > 2 * this.options.paginationPagesBySide && this.options.paginationUseIntermediate ? (n = e((this.totalPages - x - d) / 2 + d), o.push(S(n, ' page-intermediate'))) : o.push('\n                  <li class="page-item page-last-separator disabled">\n                    <a class="page-link" href="#">...</a>\n                  </li>')), n = O; n <= this.totalPages; n++) o.push(S(n))
						}
				...
				value: function(e) {
					e && l(e.currentTarget).hasClass('disabled') || (!this.options.maintainSelected && this.resetRows(), this.initPagination(), 'server' === this.options.sidePagination ? this.initServer() : this.initBody(), this.trigger('page-change', this.options.pageNumber, this.options.pageSize))
				}
			}, {
				...
				key: 'onPageNumber',
				value: function(e) {
					if(e.preventDefault(), this.options.pageNumber !== +l(e.currentTarget).text()) return this.options.pageNumber = +l(e.currentTarget).text(), this.updatePagination(e), !1
				}
			}, {
				key: 'initRow',
				value: function(e, t) {
					...
					if(!(-1 < r.findIndex(this.hiddenRows, e))) {
						if(n = r.calculateObjectValue(this.options, this.options.rowStyle, [e, t], n), n && n.css) {
							var h = !0,
								u = !1,
								g = void 0;
							try {
								for(var f, b = Object.entries(n.css)[Symbol.iterator](); !(h = (f = b.next()).done); h = !0) {
									var m = f.value,
										y = a(m, 2),
										w = y[0],
										x = y[1];
						...
						if(p = r.calculateObjectValue(this.options, this.options.rowAttributes, [e, t], p), p) {
							var S = !0,
								$ = !1,
								P = void 0;
							try {
								for(var C, T = Object.entries(p)[Symbol.iterator](); !(S = (C = T.next()).done); S = !0) {
									var O = C.value,
										_ = a(O, 2),
										R = _[0],
										I = _[1];
									c.push(R + '="' + r.escapeHTML(I) + '"')
								}
							} catch(e) {
								$ = !0, P = e
							} finally {
						...
						if(e._data && !l.isEmptyObject(e._data)) {
							var A = !0,
								F = !1,
								V = void 0;
							try {
								for(var B, N = Object.entries(e._data)[Symbol.iterator](); !(A = (B = N.next()).done); A = !0) {
									var j = B.value,
										L = a(j, 2),
										H = L[0],
										k = L[1];
						...
						return i.push('<tr', r.sprintf(' %s', c.length ? c.join(' ') : void 0), r.sprintf(' id="%s"', Array.isArray(e) ? void 0 : e._id), r.sprintf(' class="%s"', n.classes || (Array.isArray(e) ? void 0 : e._class)), ' data-index="' + t + '"', r.sprintf(' data-uniqueid="%s"', e[this.options.uniqueId]), r.sprintf('%s', d), '>'), this.options.cardView && i.push('<td colspan="' + this.header.fields.length + '"><div class="card-views">'), !this.options.cardView && this.options.detailView && (i.push('<td>'), r.calculateObjectValue(null, this.options.detailFilter, [t, e]) && i.push('\n            <a class="detail-icon" href="#">\n            <i class="' + this.options.iconsPrefix + ' ' + this.options.icons.detailOpen + '"></i>\n            </a>\n          '), i.push('</td>')), this.header.fields.forEach(function(d, p) {
							...
							if((!o.fromHtml || 'undefined' != typeof u || $.checkbox || $.radio) && $.visible && (!o.options.cardView || $.cardVisible)) {
								...
								if(g = r.calculateObjectValue($, o.header.formatters[p], [u, e, t, d], u), e['_' + d + '_data'] && !l.isEmptyObject(e['_' + d + '_data'])) {
									var B = !0,
										N = !1,
										j = void 0;
									try {
										for(var L, H = Object.entries(e['_' + d + '_data'])[Symbol.iterator](); !(B = (L = H.next()).done); B = !0) {
											var D = L.value,
												E = a(D, 2),
												z = E[0],
												U = E[1];
								...
								if($.checkbox || $.radio) {
									...
									var q = $['class'] || '',
										c = !0 === g || u || g && g.checked,
										W = !$.checkboxEnabled || g && g.disabled;
									h = [o.options.cardView ? '<div class="card-view ' + q + '">' : '<td class="bs-checkbox ' + q + '">', '<input\n              data-index="' + t + '"\n              name="' + o.options.selectItemName + '"\n              type="' + f + '"\n              ' + r.sprintf('value="%s"', e[o.options.idField]) + '\n              ' + r.sprintf('checked="%s"', c ? 'checked' : void 0) + '\n              ' + r.sprintf('disabled="%s"', W ? 'disabled' : void 0) + ' />', o.header.formatters[p] && 'string' == typeof g ? g : '', o.options.cardView ? '</div>' : '</td>'].join(''), e[o.header.stateField] = !0 === g || !!u || g && g.checked
								} else if(g = 'undefined' == typeof g || null === g ? o.options.undefinedText : g, o.options.cardView) {
									var M = o.options.showHeader ? '<span class="title"' + n + '>' + r.getFieldTitle(o.columns, d) + '</span>' : '';
									h = '<div class="card-view">' + M + '<span class="value">' + g + '</span></div>', o.options.smartDisplay && '' === g && (h = '<div class="card-view"></div>')
								} else h = '<td' + m + y + w + v + k + x + S + '>' + g + '</td>';
								i.push(h)
							}
				...
				value: function(e) {
					var t = this,
						o = this.getData();
					this.trigger('pre-body', o), this.$body = this.$el.find('>tbody'), this.$body.length || (this.$body = l('<tbody></tbody>').appendTo(this.$el)), this.options.pagination && 'server' !== this.options.sidePagination || (this.pageFrom = 1, this.pageTo = o.length);
					for(var n = l(document.createDocumentFragment()), s = !1, d = this.pageFrom - 1; d < this.pageTo; d++) {
						var i = o[d],
							p = this.initRow(i, d, o, n);
						s = s || !!p, p && 'string' == typeof p && n.append(p)
					}
					s ? this.$body.html(n) : this.$body.html('<tr class="no-records-found">' + r.sprintf('<td colspan="%s">%s</td>', this.$header.find('th').length, this.options.formatNoMatches()) + '</tr>'), e || this.scrollTo(0), this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function(e) {
						var o = e.currentTarget,
							i = e.type,
							a = e.target,
							n = l(o),
							s = n.parent(),
							d = t.data[s.data('index')],
							p = n[0].cellIndex,
							c = t.getVisibleFields(),
							h = c[t.options.detailView && !t.options.cardView ? p - 1 : p],
							u = t.columns[t.fieldsColumnsIndex[h]],
							g = r.getItemField(d, h, t.options.escape);
						if(!n.find('.detail-icon').length && (t.trigger('click' === i ? 'click-cell' : 'dbl-click-cell', h, g, d, n), t.trigger('click' === i ? 'click-row' : 'dbl-click-row', d, s, h), 'click' === i && t.options.clickToSelect && u.clickToSelect && !t.options.ignoreClickToSelectOn(a))) {
							var f = s.find(r.sprintf('[name="%s"]', t.options.selectItemName));
							f.length && f[0].click()
						}
					}), this.$body.find('> tr[data-index] > td > .detail-icon').off('click').on('click', function(i) {
						i.preventDefault();
						var e = l(i.currentTarget),
							a = e.parent().parent(),
							n = a.data('index'),
							s = o[n];
						if(a.next().is('tr.detail-view')) e.find('i').attr('class', r.sprintf('%s %s', t.options.iconsPrefix, t.options.icons.detailOpen)), t.trigger('collapse-row', n, s, a.next()), a.next().remove();
						else {
							...
							var d = a.next().find('td'),
								p = r.calculateObjectValue(t.options, t.options.detailFormatter, [n, s, d], '');
							1 === d.length && d.append(p), t.trigger('expand-row', n, s, d)
						}
						...
						if(i) {
							...
							var n = t.header.fields[o],
								s = t.getVisibleFields().indexOf(n);
							if(-1 !== s) {
								t.options.detailView && !t.options.cardView && (s += 1);
								var d = function(e, o) {
										t.$body.find('>tr:not(.no-records-found)').each(function(a, i) {
											var r = l(i),
												d = r.find(t.options.cardView ? '.card-view' : 'td').eq(s),
												p = e.indexOf(' '),
												c = e.substring(0, p),
												h = e.substring(p + 1);
											d.find(h).off(c).on(c, function(i) {
												var e = r.data('index'),
													a = t.data[e],
													s = a[n];
												o.apply(t, [i, s, a, e])
									...
									h = void 0;
								try {
									for(var u, g = Object.entries(i)[Symbol.iterator](); !(p = (u = g.next()).done); p = !0) {
										var f = u.value,
											b = a(f, 2),
											m = b[0],
											y = b[1];
				...
				value: function(e, t, o) {
					...
					if((this.header.sortNames[n] && (s.sortName = this.header.sortNames[n]), this.options.pagination && 'server' === this.options.sidePagination && (s.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, s.pageNumber = this.options.pageNumber), o || this.options.url || this.options.ajax) && ('limit' === this.options.queryParamsType && (s = {
							search: s.searchText,
							sort: s.sortName,
							order: s.sortOrder
						}, this.options.pagination && 'server' === this.options.sidePagination && (s.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1), s.limit = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, 0 === s.limit && delete s.limit)), l.isEmptyObject(this.filterColumnsPartial) || (s.filter = JSON.stringify(this.filterColumnsPartial, null)), a = r.calculateObjectValue(this.options, this.options.queryParams, [s], a), l.extend(a, t || {}), !1 !== a)) {
						e || this.$tableLoading.show();
						var d = l.extend({}, r.calculateObjectValue(null, this.options.ajaxOptions), {
						...
						this.options.ajax ? r.calculateObjectValue(this, this.options.ajax, [d], null) : (this._xhr && 4 !== this._xhr.readyState && this._xhr.abort(), this._xhr = l.ajax(d))
					}
				}
			}, {
				key: 'initSearchText',
				...
				value: function() {
					...
					this.$header.find('th').each(function(t, o) {
						l(o).find('.sortable').removeClass('desc asc').addClass(l(o).data('field') === e.options.sortName ? e.options.sortOrder : 'both')
					})
				}
			}, {
				key: 'updateSelected',
				value: function() {
					...
					this.$selectAll.add(this.$selectAll_).prop('checked', e), this.$selectItem.each(function(e, t) {
						l(t).closest('tr')[l(t).prop('checked') ? 'addClass' : 'removeClass']('selected')
					})
				}
			}, {
				key: 'updateRows',
				value: function() {
					...
					this.$selectItem.each(function(t, o) {
						e.data[l(o).data('index')][e.header.stateField] = l(o).prop('checked')
					})
				}
			}, {
				key: 'resetRows',
				value: function() {
					var e = !0,
						...
						o = void 0;
					try {
						for(var i, a, n = this.data[Symbol.iterator](); !(e = (i = n.next()).done); e = !0) a = i.value, this.$selectAll.prop('checked', !1), this.$selectItem.prop('checked', !1), this.header.stateField && (a[this.header.stateField] = !1)
					} catch(e) {
						t = !0, o = e
					} finally {
						try {
				...
				key: 'trigger',
				value: function(e) {
					for(var o, i = e + '.bs.table', a = arguments.length, n = Array(1 < a ? a - 1 : 0), s = 1; s < a; s++) n[s - 1] = arguments[s];
					(o = this.options)[t.EVENTS[i]].apply(o, n), this.$el.trigger(l.Event(i), n), this.options.onAll(i, n), this.$el.trigger(l.Event('all.bs.table'), [i, n])
				}
			}, {
				key: 'resetHeader',
				value: function() {
					clearTimeout(this.timeoutId_), this.timeoutId_ = setTimeout(l.proxy(this.fitHeader, this), this.$el.is(':hidden') ? 100 : 0)
				}
			}, {
				key: 'fitHeader',
				value: function() {
					var e = this;
					if(this.$el.is(':hidden')) return void(this.timeoutId_ = setTimeout(l.proxy(this.fitHeader, this), 100));
					...
					var a = l('.focus-temp:visible:eq(0)');
					0 < a.length && (a.focus(), this.$header.find('.focus-temp').removeClass('focus-temp')), this.$header.find('th[data-field]').each(function(t, o) {
						e.$header_.find(r.sprintf('th[data-field="%s"]', l(o).data('field'))).data(l(o).data())
					});
					for(var n = this.getVisibleFields(), s = this.$header_.find('th'), d = this.$body.find('>tr:first-child:not(.no-records-found)'); d.length && d.find('>td[colspan]:not([colspan="1"])').length;) d = d.next();
					d.find('> *').each(function(t, o) {
						var i = l(o),
							a = t;
						if(e.options.detailView && !e.options.cardView) {
							if(0 === t) {
								var d = s.filter('.detail'),
									p = d.width() - d.find('.fht-cell').width();
								d.find('.fht-cell').width(i.innerWidth() - p)
							}
							a = t - 1
						}
						if(-1 !== a) {
							var c = e.$header_.find(r.sprintf('th[data-field="%s"]', n[a]));
							1 < c.length && (c = l(s[i[0].cellIndex]));
				...
				value: function() {
					...
					if(this.options.showFooter && !this.options.cardView) {
						!this.options.cardView && this.options.detailView && t.push('<td><div class="th-inner">&nbsp;</div><div class="fht-cell"></div></td>');
						var o = !0,
							i = !1,
							n = void 0;
						try {
							for(var s, d = this.columns[Symbol.iterator](); !(o = (s = d.next()).done); o = !0) {
								var p = s.value,
									c = '',
									h = '',
									u = [],
									g = {},
									f = r.sprintf(' class="%s"', p['class']);
								if(!p.visible) return;
								if(this.options.cardView && !p.cardVisible) return;
								if(c = r.sprintf('text-align: %s; ', p.falign ? p.falign : p.align), h = r.sprintf('vertical-align: %s; ', p.valign), g = r.calculateObjectValue(null, this.options.footerStyle), g && g.css) {
									var b = !0,
										m = !1,
										y = void 0;
									try {
										for(var w, v = Object.keys(g.css)[Symbol.iterator](); !(b = (w = v.next()).done); b = !0) {
											var k = w.value,
												x = a(k, 2),
												S = x[0],
												$ = x[1];
								...
								t.push('<td', f, r.sprintf(' style="%s"', c + h + u.concat().join('; ')), '>'), t.push('<div class="th-inner">'), t.push(r.calculateObjectValue(p, p.footerFormatter, [e], '&nbsp;') || '&nbsp;'), t.push('</div>'), t.push('<div class="fht-cell"></div>'), t.push('</div>'), t.push('</td>')
							}
						} catch(e) {
							i = !0, n = e
						} finally {
						...
						this.$tableFooter.find('tr').html(t.join('')), this.$tableFooter.show(), clearTimeout(this.timeoutFooter_), this.timeoutFooter_ = setTimeout(l.proxy(this.fitFooter, this), this.$el.is(':hidden') ? 100 : 0)
					}
				}
			}, {
				key: 'fitFooter',
				value: function() {
					if(clearTimeout(this.timeoutFooter_), this.$el.is(':hidden')) return void(this.timeoutFooter_ = setTimeout(l.proxy(this.fitFooter, this), 100));
					var e = this.$el.css('width'),
						t = e > this.$tableBody.width() ? r.getScrollBarWidth() : 0;
					this.$tableFooter.css({
						"margin-right": t
					}).find('table').css('width', e).attr('class', this.$el.attr('class'));
					var o = this.$tableFooter.find('td');
					this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function(e, t) {
						var i = l(t);
						o.eq(e).find('.fht-cell').width(i.innerWidth())
				...
				value: function() {
					...
					this.trigger('scroll-body'), this.$tableBody.off('scroll').on('scroll', function(t) {
						var o = t.currentTarget;
						e.options.showHeader && e.options.height && e.$tableHeader.scrollLeft(l(o).scrollLeft()), e.options.showFooter && !e.options.cardView && e.$tableFooter.scrollLeft(l(o).scrollLeft())
					})
				}
			}, {
				key: 'toggleColumn',
				...
				value: function() {
					var e = [],
						...
						i = void 0;
					try {
						for(var a, n = this.header.fields[Symbol.iterator](); !(t = (a = n.next()).done); t = !0) {
							var s = a.value,
				...
				value: function(e) {
					...
					if(this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), t += this.$header.outerHeight()) : (this.$tableHeader.hide(), this.trigger('post-header')), this.options.showFooter && (this.resetFooter(), this.options.height && (t += this.$tableFooter.outerHeight() + 1)), this.options.height) {
						var o = this.$toolbar.outerHeight(!0),
							i = this.$pagination.outerHeight(!0),
							a = this.options.height - o - i,
				...
				value: function(e) {
					...
					return(this.searchText || this.options.sortName || !l.isEmptyObject(this.filterColumns) || !l.isEmptyObject(this.filterColumnsPartial)) && (t = this.data), e ? t.slice(this.pageFrom - 1, this.pageTo) : t
				}
			}, {
				key: 'load',
				value: function(e) {
				...
				value: function(e) {
					...
					if(e.hasOwnProperty('field') && e.hasOwnProperty('values')) {
						for(o = t - 1; 0 <= o; o--)(i = this.options.data[o], !!i.hasOwnProperty(e.field)) && e.values.includes(i[e.field]) && (this.options.data.splice(o, 1), 'server' === this.options.sidePagination && (this.options.totalRows -= 1));
				...
				value: function(e) {
					var t = Array.isArray(e) ? e : [e],
						...
						a = void 0;
					try {
						for(var n, s, r = t[Symbol.iterator](); !(o = (n = r.next()).done); o = !0)
							if(s = n.value, s.hasOwnProperty('id') && s.hasOwnProperty('row')) {
								var d = this.options.data.indexOf(this.getRowByUniqueId(s.id)); - 1 !== d && l.extend(this.options.data[d], s.row)
							}
					} catch(e) {
						i = !0, a = e
					} finally {
				...
				value: function(e) {
					if(e.hasOwnProperty('field') && e.hasOwnProperty('title') && (this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape ? r.escapeHTML(e.title) : e.title, this.columns[this.fieldsColumnsIndex[e.field]].visible)) {
						...
						t.find('th[data-field]').each(function(t, o) {
							if(l(o).data('field') === e.field) return l(l(o).find('.th-inner')[0]).text(e.title), !1
						})
					}
				}
			}, {
				...
				value: function(e) {
					var t = Array.isArray(e) ? e : [e],
						...
						a = void 0;
					try {
						for(var n, s, r = t[Symbol.iterator](); !(o = (n = r.next()).done); o = !0)(s = n.value, s.hasOwnProperty('index') && s.hasOwnProperty('row')) && l.extend(this.options.data[s.index], s.row)
					} catch(e) {
						i = !0, a = e
					} finally {
						try {
				...
				value: function(e) {
					...
					var t = this.getData(),
						...
						n = void 0;
					try {
						for(var s, l, r = t[Symbol.iterator](); !(i = (s = r.next()).done); i = !0) l = s.value, this.hiddenRows.includes(l) && o.push(l)
					} catch(e) {
						a = !0, n = e
					} finally {
						try {
				...
				value: function(e) {
					...
					if(!(0 > t || 0 > o || t >= this.data.length)) {
						for(s = t; s < t + a; s++)
							for(i = o; i < o + n; i++) l.eq(s).find('>td').eq(i).hide();
					...
					if(e.hasOwnProperty('id') && e.hasOwnProperty('field') && e.hasOwnProperty('value')) {
						...
						o.forEach(function(e) {
							var o = e.id,
								i = e.field,
								a = e.value,
								n = t.options.data.indexOf(t.getRowByUniqueId(o)); - 1 === n || (t.data[n][i] = a)
				...
				key: 'getOptions',
				value: function() {
					var e = l.extend({}, this.options);
					return delete e.data, l.extend(!0, {}, e)
				}
			}, {
				key: 'getSelections',
				value: function() {
				...
				value: function() {
					var e = this.$selectItem.filter(':enabled'),
						t = e.filter(':checked');
					e.each(function(e, t) {
						l(t).prop('checked', !l(t).prop('checked'))
				...
				value: function(e, t) {
					...
					if(o.is(':radio') || this.options.singleSelect) {
						var a = !0,
							...
							s = void 0;
						try {
							for(var l, d, r = this.options.data[Symbol.iterator](); !(a = (l = r.next()).done); a = !0) d = l.value, d[this.header.stateField] = !1
						} catch(e) {
							n = !0, s = e
						} finally {
							try {
				...
				key: 'destroy',
				value: function() {
					this.$el.insertBefore(this.$container), l(this.options.toolbar).insertBefore(this.$el), this.$container.next().remove(), this.$container.remove(), this.$el.html(this.$el_.html()).css('margin-top', '0').attr('class', this.$el_.attr('class') || '')
				}
			}, {
				key: 'showLoading',
				value: function() {
				...
				value: function(e) {
					var t = !0,
						...
						i = void 0;
					try {
						for(var a, n, s = this.columns[Symbol.iterator](); !(t = (a = s.next()).done); t = !0) n = a.value, n.visible = e
					} catch(e) {
						o = !0, i = e
					} finally {
						try {
					...
					if(this.initHeader(), this.initSearch(), this.initPagination(), this.initBody(), this.options.showColumns) {
						var l = this.$toolbar.find('.keep-open input').prop('disabled', !1);
						l.filter(':checked').length <= this.options.minimumCountColumns && l.filter(':checked').prop('disabled', !0)
					}
				}
			}, {
				key: 'showAllColumns',
				...
				key: 'filterBy',
				value: function(e) {
					this.filterColumns = l.isEmptyObject(e) ? {} : e, this.options.pageNumber = 1, this.initSearch(), this.updatePagination()
				}
			}, {
				key: 'scrollTo',
				value: function(e) {
				...
				key: 'refreshOptions',
				value: function(e) {
					r.compareObjects(this.options, e, !0) || (this.options = l.extend(this.options, e), this.trigger('refresh-options', this.options), this.destroy(), this.init())
				}
			}, {
				key: 'resetSearch',
				value: function(e) {
					...
					if(e) {
						...
						if(o.next().is('tr.detail-view') ? !o.next().next().is('tr.detail-view') && (o.next().find('.detail-icon').click(), n = !0) : (o.find('> td > .detail-icon').click(), n = !0), n) try {
							s = setInterval(function() {
								a = t.$body.find('tr.detail-view').last().find('.detail-icon'), 0 < a.length ? a.click() : clearInterval(s)
							}, 1)
						} catch(e) {
							clearInterval(s)
						}
					} else
						for(var d = this.$body.children(), p = 0; p < d.length; p++) this.expandRow_(!0, l(d[p]).data('index'))
				}
			}, {
				key: 'collapseAllRows',
				value: function(e) {
					if(e) this.expandRow_(!1, 0);
						...
						for(var t = this.$body.children(), o = 0; o < t.length; o++) this.expandRow_(!1, l(t[o]).data('index'))
				}
			}, {
		...
		l.BootstrapTable = c, l.fn.bootstrapTable = function(e) {
			for(var t = arguments.length, o = Array(1 < t ? t - 1 : 0), i = 1; i < t; i++) o[i - 1] = arguments[i];
			var a;
			return this.each(function(t, i) {
				var s = l(i).data('bootstrap.table'),
					r = l.extend({}, c.DEFAULTS, l(i).data(), 'object' === ('undefined' == typeof e ? 'undefined' : n(e)) && e);
				if('string' == typeof e) {
					var d;
					if(!h.includes(e)) throw new Error('Unknown method: ' + e);
					if(!s) return;
					a = (d = s)[e].apply(d, o), 'destroy' === e && l(i).removeData('bootstrap.table')
				}
				s || l(i).data('bootstrap.table', s = new l.BootstrapTable(i, r))
			}), 'undefined' == typeof a ? this : a
		}, l.fn.bootstrapTable.Constructor = c, l.fn.bootstrapTable.defaults = c.DEFAULTS, l.fn.bootstrapTable.columnDefaults = c.COLUMN_DEFAULTS, l.fn.bootstrapTable.locales = c.LOCALES, l.fn.bootstrapTable.methods = h, l.fn.bootstrapTable.utils = r, l(function() {
			l('[data-toggle="table"]').bootstrapTable()
		})
	})(jQuery)
});