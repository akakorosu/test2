...
public class Des {
     ...
     * @throws Exception 
     */
    public static String encrypt(String srcStr, String skey, Charset charset) throws Exception {
     ...
     * @throws Exception
     */
    public static String decrypt(String hexStr, String skey, Charset charset) throws Exception {
