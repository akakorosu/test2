...
<cxt:commonLinks />
	...
	<script src="<%=request.getContextPath()%>/pages/jsp/dpi/groupClass/groupClassList.js"></script>
		...
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
	            ...
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.GroupClass" name="entityName"/>
					<jsp:param value="groupClassService" name="beanName"/>
					<jsp:param value="group_class.xlsx" name="templateName"/>
