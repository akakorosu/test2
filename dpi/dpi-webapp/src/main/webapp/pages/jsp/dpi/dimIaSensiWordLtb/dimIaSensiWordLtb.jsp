	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<input type="text" placeholder="敏感词" class="searchField input-md" id="sensi_word" name='sensiWord'>
				...
				<!--批处理 -->
	           	<jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.DimIaSensiWordLtb" name="entityName"/>
					<jsp:param value="dimIaSensiWordLtbService" name="beanName"/>
					<jsp:param value="dim_ia_sensi_word_ltb.xlsx" name="templateName"/>
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/dimIaSensiWordLtb/dimIaSensiWordLtb.js"></script>
</html>