	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				...
				<input type="text" placeholder="UA_KEY" class="searchField input-md" id="uaKey1"  name="uaKey">
				...
				<button class="btn btn-primary" type="button" id="searchKeyList">查询</button>
				<button class="btn btn-primary" type="button" id="clearSearch" onclick="topclear('gridSearch')">清空</button>
	            <button class="btn btn-warning" type="button" id="createKeyBtn">新建</button>
	            <button class="btn btn-warning" type="button" id="backtoye">返回</button>
			
				<!--批处理 -->
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.DimIaUserAgentKey" name="entityName"/>
					<jsp:param value="dimIaUserAgentKeyService" name="beanName"/>
					<jsp:param value="dim_ia_useragent_key.xlsx" name="templateName"/>
					<jsp:param value="0,1,2,3,4,5,6" name="fieldNums"/>
					<jsp:param value="1,2" name="textFieldNums"/>
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/dimIaUserAgentKey/dimIaUserAgentKey.js"></script>
</html>