...
<cxt:commonLinks />
	...
	<script src="<%=request.getContextPath()%>/pages/jsp/dpi/urlPath/urlPathList.js"></script>
		...
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
	            ...
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
					<jsp:param value="com.bonc.dpi.dao.entity.UrlPath" name="entityName"/>
					<jsp:param value="urlPathService" name="beanName"/>
					<jsp:param value="dim_ia_url_path.xlsx" name="templateName"/>
