...
<title>全部榜单</title>
	<script type="text/javascript">
		var contentLabelName1='<%=request.getAttribute("contentLabelName1")%>';
		var contentLabelName2='<%=request.getAttribute("contentLabelName2")%>';
		var mapJson = '<%=request.getAttribute("mapJson")%>';
        var cityId = '<%=request.getAttribute("cityId")%>';
        var time = '<%=request.getAttribute("monthId")%>';
		var contentLabelName1_list='<%=request.getAttribute("contentLabelName1List")%>';
		contentLabelName1_list=JSON.parse(contentLabelName1_list);
		var contentLabelName_map = '<%=request.getAttribute("contentLabelNameMap")%>';
		contentLabelName_map=JSON.parse(contentLabelName_map);
		var contentLabelName1_data_list = '<%=request.getAttribute("contentLabelName1DataList")%>';
		contentLabelName1_data_list=JSON.parse(contentLabelName1_data_list);
		var contentLabelName2_data_list = '<%=request.getAttribute("contentLabelName2DataList")%>';
		contentLabelName2_data_list=JSON.parse(contentLabelName2_data_list);
		if(contentLabelName1==contentLabelName2_data_list){
			contentLabelName2_data_list='';
		}
	</script>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/pages/jsp/dpi/billBoard/billAll.css" />
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/billBoard/billAll.js"></script>
</html>