...
public class AES {
	...
	public static final String PASS = "bonc_rddpi000000";
	...
	public static void main(String[] args) {
		try {
			// 加密
			System.out.println("加密result = " + encrypt("bonc123"));
			
			// 解密
			System.out.println("解密result = " + decrypt("tqnGz/h1J/+IkSO63JEODg=="));
//			AES.encrypt(new Gson().toJson(obj).toString())
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
