...
<body style="overflow-y:visible;overflow-x:visible;" id="bdy">
	<!-- 整体宽度min-width:1240 -->
	<!-- 顶部导航栏开始 -->
	...
	<div class="main-container" id="main-container">
		...
		<!-- 路径导航-->
			...
			<div class="page-content">
				<!-- iframe引入页面 -->
				<iframe id="contentLoader" name="ifrmname" width="100%" frameborder="0" style="overflow:hidden;padding-left:100px;">
				</iframe>
			</div>
		</div>
		<!--底部 -->
		<div class="footer" style="padding-top:0px;height: 1px">
			<div class="footer-inner" style="position: static;">
				<div id="ft" class="footer-content" style="background:#fff;">
<%--					<span class="grey bigger">--%>
<%--						北京东方国信科技股份有限公司 移动事业部&copy; 2020--%>
<%--					</span>--%>
				</div>
			</div>
		</div>
...
setTimeout(function(){
	...
	let flexlist=document.getElementById("flex-list").offsetHeight;
//	let bdy=document.getElementById("bdy").offsetHeight;
	let foot=document.querySelector("#ft").getBoundingClientRect().top;
	let frame = document.querySelector("#contentLoader");
	frame.height=foot-height-flexlist;
},500)
