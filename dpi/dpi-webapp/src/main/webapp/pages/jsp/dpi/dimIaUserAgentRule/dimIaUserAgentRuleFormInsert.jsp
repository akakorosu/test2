...
<div id="showRuleForm">
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${vo.prodIdParam }" type="text" placeholder="产品ID"  onlyUrl="/uarule/check,id,prodIdParam,uaKeyRule|联合校验重复!" class="formField required"  id="prodIdParam" name="prodIdParam" readonly/>
		</div>
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${vo.uaKeyRule }" type="text" placeholder="识别规则"  onlyUrl="/uarule/check,id,prodIdParam,uaKeyRule|联合校验重复!"  class="formField required" id="uaKeyRule" name="uaKeyRule" />
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/dimIaUserAgentRule/dimIaUserAgentRuleFormInsert.js"></script>
