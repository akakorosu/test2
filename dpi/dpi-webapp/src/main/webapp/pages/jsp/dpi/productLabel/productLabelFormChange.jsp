...
<div id="piForm">
	...
	<input type="hidden" class="formField" id='joinLabelName' name="joinLabelName" value="${vo.joinLabelName}">
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${vo.labelName }" type="text" placeholder="分类ID"    class="formField required" id="label_name1" name="labelName"  readonly>
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/productLabel/productLabelFormChange.js"></script>
