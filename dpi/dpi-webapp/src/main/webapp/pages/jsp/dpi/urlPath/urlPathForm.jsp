...
<div id="upForm">
	...
	<input type="hidden" class="formField" name="author" value="${vo.hostOld}">
	<input type="hidden" class="formField" name="opTime" value="${vo.regexpRuleOld}">
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${vo.host }" type="text" placeholder="域名" onlyUrl="/urlPath/check,id,hostParam,regexpRule|联合主键重复" class="formField required" id="host" name="hostParam" />
		</div>
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${vo.regexpRule }" type="text" placeholder="匹配规则" onlyUrl="/urlPath/check,id,hostParam,regexpRule|联合主键重复" class="formField required " id="regexpRule" name="regexpRule">
		</div>
...
<script src="<%=request.getContextPath()%>/pages/jsp/dpi/urlPath/urlPathForm.js"></script>
