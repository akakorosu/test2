 ...
 */
@Controller
@RequestMapping(value = "/depthRuleCheck")
public class DepthRuleCheckAction {

	@Resource
	private DepthRuleCheckService cwlService;
	...
	@ResponseBody
	public PageJqGrid<DepthRuleCheck> selectPageList(DepthRuleCheck vo, Integer page, Integer rows) throws Exception{
		Page<DepthRuleCheck> pageList = this.cwlService.selectList(vo, page, rows);
		PageJqGrid<DepthRuleCheck> pageJqGrid = new PageJqGrid<DepthRuleCheck>(pageList);
		return pageJqGrid;
	}
	...
	@ResponseBody
	public Boolean audit(@RequestParam String id) throws Exception{
		return cwlService.audit(id);
	}
	/**
	 * 删除
	 * @param id
