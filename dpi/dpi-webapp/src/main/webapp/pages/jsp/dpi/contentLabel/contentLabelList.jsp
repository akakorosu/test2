...
<%-- 	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/jsp/dpi/common/datepickerDpi.js"></script> --%>
	<script src="<%=request.getContextPath()%>/pages/jsp/dpi/contentLabel/contentLabelList.js"></script>
	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			...
			<div class="grid-search-div" id="gridSearch">
				<!-- <input type="text" placeholder="内容分类" class="searchField input-md" id="contentLabelName1" name="contentLabelName1"> -->
				<select  id="contentLabelName11" placeholder="分类名称" class="searchField formField input-md" name='contentLabelName1'>
				</select>
				<input type="text" placeholder="标签" class="searchField input-md" id="label" name="label">
				<%--<input type="text" placeholder="标签"  class="searchField input-md" id="label" name="label" readOnly="readonly" onclick="select_label()">--%>
	            ...
	            <button class="btn btn-warning" type="button" id="createUpBtn" >新建</button>
				
				<!--批处理 -->
	            <jsp:include page="/pages/jsp/frame/operationFlow.jsp">
	            	<jsp:param value="1,1,1,1,1" name="isShow"/>
					<jsp:param value="com.bonc.dpi.dao.entity.ContentLabel" name="entityName"/>
					<jsp:param value="contentLabelService" name="beanName"/>
					<jsp:param value="content_label.xlsx" name="templateName"/>
